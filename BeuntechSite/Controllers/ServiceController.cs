...
namespace BeuntechSite.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Text,ImageUrl,IsQuestion,IsImageActive")] Service service)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Text,ImageUrl,IsQuestion,IsImageActive")] Service service)
        {
            if (ModelState.IsValid)
            {
